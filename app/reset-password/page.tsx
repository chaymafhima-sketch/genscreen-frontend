...
import { Lock, ArrowRight, MonitorPlay, AlertCircle, CheckCircle2, ArrowLeft } from "lucide-react";
  ...
  if (!token) {
    return (
      <div className="text-center">
        <div className="flex items-center gap-3 rounded-xl bg-red-500/10 p-4 text-red-500 border border-red-500/20 mb-6">
          <AlertCircle size={20} className="shrink-0" />
          <span className="text-sm font-medium">Token manquant ou invalide.</span>
        </div>
        <button
