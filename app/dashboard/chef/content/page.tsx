      ...
      <div className="space-y-8">
        ...
        <form onSubmit={handleDiffusion} className="soft-card p-8 shadow-sm relative overflow-hidden flex flex-col h-[600px]">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
            <h3 className="text-lg font-bold text-foreground">Sélectionner un contenu</h3>
              ...
              contents
                ...
                .map((item) => (
                  <div
                    ...
                    className={`p-4 rounded-2xl cursor-pointer transition-all border flex items-center justify-between group ${selectedContentId === (item._id || item.id)
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div className={`h-5 w-5 rounded-full border-2 flex items-center justify-center transition-all ${selectedContentId === (item._id || item.id)
