    ...
    <div className="space-y-8 animate-in fade-in duration-700">
      ...
      <div className="soft-card p-8 max-w-3xl">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <div className="p-4 rounded-xl bg-muted/40 border border-border"><p className="text-xs uppercase tracking-wider text-muted-foreground mb-2 flex items-center gap-2"><Mail size={14} /> {t.profile.email}</p><p className="text-sm font-medium text-foreground">{profile?.email || "---"}</p></div>
