    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="soft-card p-8 max-w-3xl">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          ...
          <div className="p-4 rounded-xl bg-muted/40 border border-border">
            <p className="text-xs uppercase tracking-wider text-muted-foreground mb-2 flex items-center gap-2"><Shield size={14} /> Rôle</p>
        ...
        <form onSubmit={handleSave} className="space-y-5">
          <div className="space-y-2">
            <label className="text-sm font-medium text-muted-foreground flex items-center gap-2"><User size={15} /> Nom complet</label>
            <input
              value={form.fullname}
          ...
          <div className="space-y-2">
            <label className="text-sm font-medium text-muted-foreground flex items-center gap-2"><MapPin size={15} /> Ville</label>
            <input
              value={form.city}
          ...
          <div className="space-y-2">
            <label className="text-sm font-medium text-muted-foreground flex items-center gap-2"><MapPin size={15} /> Adresse</label>
            <input
              value={form.address}
