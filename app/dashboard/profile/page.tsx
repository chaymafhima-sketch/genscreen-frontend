    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="soft-card p-8 max-w-3xl">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          ...
          <div className="p-4 rounded-xl bg-muted/40 border border-border">
            <p className="text-xs uppercase tracking-wider text-muted-foreground mb-2 flex items-center gap-2"><Shield size={14} /> Role</p>
            <p className="text-sm font-medium text-foreground uppercase">{profile?.role || "—"}</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSave} className="space-y-5">
          ...
          <div className="pt-3 flex justify-end">
            <button type="submit" disabled={saving} className="bg-primary hover:opacity-90 disabled:opacity-50 text-primary-foreground px-5 py-2.5 rounded-xl text-sm font-medium transition-all shadow-lg shadow-primary/20 active:scale-95 flex items-center gap-2">
