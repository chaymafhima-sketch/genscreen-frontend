        ...
        {showSearchDropdown && (
          <div className="absolute top-full left-0 mt-3 w-[450px] bg-card/95 backdrop-blur-3xl border border-border rounded-2xl shadow-xl overflow-hidden animate-in fade-in slide-in-from-top-2 duration-200">
            <div className="p-4 border-b border-border bg-muted/30">
              <h5 className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest">Résultats de recherche rapide</h5>
            </div>
                ...
                <div className="p-6 bg-muted/30 border-b border-border">
                   <div className="flex items-center gap-4">
                      ...
                      <div className="min-w-0">
                        <h4 className="text-sm font-bold text-foreground truncate">{userData.fullname || userData.name || "Administrateur"}</h4>
